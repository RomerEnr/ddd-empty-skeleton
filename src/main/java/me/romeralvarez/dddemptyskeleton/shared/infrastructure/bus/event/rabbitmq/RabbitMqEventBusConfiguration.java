...
import me.romeralvarez.dddemptyskeleton.shared.infrastructure.bus.event.DomainEventSubscribersInformation;
import me.romeralvarez.dddemptyskeleton.shared.infrastructure.bus.event.DomainEventsInformation;
...
public class RabbitMqEventBusConfiguration {
    ...
    public RabbitMqEventBusConfiguration(
        ...
        @Value("${spring.rabbitmq.exchange:domain_events}") String exchangeName
    ) {
